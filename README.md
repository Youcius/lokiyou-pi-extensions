...
| `@lokiyou/modelscope-vision` | Simple image understanding for Pi Coding Agent. Install it, set your API key, and ask normal questions about images. | `pi install npm:@lokiyou/modelscope-vision` |
